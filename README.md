# goose [![Goose CI](https://github.com/WinXaito/goose/actions/workflows/ci.yml/badge.svg)](https://github.com/WinXaito/goose/actions/workflows/ci.yml) [![Go Reference](https://pkg.go.dev/badge/github.com/WinXaito/goose/v3.svg)](https://pkg.go.dev/github.com/WinXaito/goose/v3)

Goose is a database migration tool. Manage your database schema by creating incremental SQL changes or Go functions.

Starting with [v3.0.0](https://github.com/WinXaito/goose/releases/tag/v3.0.0) this project adds Go module support, but maintains backwards compataibility with older `v2.x.y` tags.

### Goals of this fork

`github.com/WinXaito/goose` is a fork of `bitbucket.org/liamstask/goose` with the following changes:
- No config files
...
# Install
    ...
    $ go get -u github.com/WinXaito/goose/v3/cmd/goose
...
Package `github.com/WinXaito/goose/iofs` allows to run migrations using this filesystem abstraction.
...
import (
    ...
    "github.com/WinXaito/goose"
    "github.com/WinXaito/goose/iofs"
)
...
2. Import `github.com/WinXaito/goose`
...
# Hybrid Versioning
Please, read the [versioning problem](https://github.com/WinXaito/goose/issues/63#issuecomment-428681694) first.
